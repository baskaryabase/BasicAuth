...
render(){
  return(
    <div className="hidden-sm col-xs-12 col-md-9">
    <div className="pv3 col-xs-12">
      <form className="form-group">
        <div id="results" className="form-group">
          <div>
            <div className="col-md-2 col-sm-2 col-xs-4 form-group">
              <label className="control-label"><span className="hidden-xs glyphicon glyphicon-map-marker"></span>Location
              </label>
            ...
            <div className="col-sm-2 col-xs-6" style={{marginTop:"31px"}}>
              <ButtonGroup>
